...
export class UserService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllUsers(observe?: 'body', reportProgress?: boolean): Observable<Array<User>>;
    public findAllUsers(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<User>>>;
    public findAllUsers(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<User>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findUserById(userId: number, observe?: 'body', reportProgress?: boolean): Observable<User>;
    public findUserById(userId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<User>>;
    public findUserById(userId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<User>>;
    public findUserById(userId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<User>('get',`${this.basePath}/api/v1/User/${encodeURIComponent(String(userId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
