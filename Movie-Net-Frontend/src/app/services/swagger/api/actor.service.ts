...
export class ActorService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateActor(actorId: number, body?: Actor, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateActor(actorId: number, body?: Actor, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateActor(actorId: number, body?: Actor, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateActor(actorId: number, body?: Actor, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
